...
. 사용자 환경에 적합한 번들 YAML 파일을 사용하여 Astra Trident를 설치합니다 `<bundle.yaml>` 있습니다
`bundle_pre_1_25.yaml` 또는 `bundle_post_1_25.yaml` Kubernetes 버전을 기반으로 합니다. 예를 들어 Astra Trident 23.07을 설치하는 경우 다음 명령을 실행합니다.
+
[listing]
----
