...
NetApp은 제품과 서비스를 지속적으로 개선 및 개선하고 있습니다. Astra Trident의 최신 기능 몇 가지를 소개합니다. 이전 릴리스는 를 참조하십시오 https://["이전 버전의 문서"].
...
* iSCSI PVS에 대해 온라인 공간 재확보를 수행하려면 작업자 노드의 기본 OS에 볼륨에 마운트 옵션을 전달해야 할 수 있습니다. 이는 디카드(disscard)가 필요한 RHEL/RedHat CoreOS 인스턴스에 적용됩니다 https://["마운트 옵션"^]에 mountmounted 폐기 옵션이 포함되어 있는지 확인합니다 https://["d4b9b9554fd820f43eae492d33e41167"^] 온라인 블록 삭제를 지원합니다.
...
* https://["Astra Trident GitHub를 참조하십시오"^]
* https://["Astra Trident 블로그"^]
