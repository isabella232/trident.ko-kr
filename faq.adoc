...
. 에 연락하여 지원 케이스를 제출하십시오 https://["NetApp 지원"^].
...
에서 문제를 만듭니다 https://["Astra Trident GitHub를 참조하십시오"^] 제목에 * RFE * 를 기재하고 문제에 대한 설명을 기재하십시오.



=== 결함은 어디에서 제기합니까?

에서 문제를 만듭니다 https://["Astra Trident GitHub를 참조하십시오"^]. 문제와 관련된 모든 필수 정보와 로그를 포함해야 합니다.
